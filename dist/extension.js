...
/***/ "./node_modules/got/dist/source/as-promise/calculate-retry-delay.js":
/*!**************************************************************************!*\
  !*** ./node_modules/got/dist/source/as-promise/calculate-retry-delay.js ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/got/dist/source/as-promise/core.js":
/*!*********************************************************!*\
  !*** ./node_modules/got/dist/source/as-promise/core.js ***!
  \*********************************************************/
/*! no static exports found */
...
const calculate_retry_delay_1 = __webpack_require__(/*! ./calculate-retry-delay */ "./node_modules/got/dist/source/as-promise/calculate-retry-delay.js");
const types_1 = __webpack_require__(/*! ./types */ "./node_modules/got/dist/source/as-promise/types.js");
const core_1 = __webpack_require__(/*! ./core */ "./node_modules/got/dist/source/as-promise/core.js");
...
__export(__webpack_require__(/*! ./types */ "./node_modules/got/dist/source/as-promise/types.js"));
...
Object.defineProperty(exports, "__esModule", { value: true });
const p_cancelable_1 = __webpack_require__(/*! p-cancelable */ "./node_modules/p-cancelable/index.js");
...
__export(__webpack_require__(/*! ./create */ "./node_modules/got/dist/source/create.js"));
__export(__webpack_require__(/*! ./as-promise */ "./node_modules/got/dist/source/as-promise/index.js"));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SalesforceReferenceDocTypes = exports.SalesforceReferenceItem = exports.invalidateSalesforceReferenceCache = void 0;
...
(function (DocTypeName) {
    DocTypeName["APEX"] = "APEX";
    DocTypeName["VISUALFORCE"] = "VISUALFORCE";
    DocTypeName["LIGHTNING_CONSOLE"] = "LIGHTNING_CONSOLE";
    DocTypeName["CLASSIC_CONSOLE"] = "CLASSIC_CONSOLE";
    DocTypeName["METADATA"] = "METADATA";
})(DocTypeName || (DocTypeName = {}));
function docTypeNameTitleCase(docTypeName) {
...
function invalidateSalesforceReferenceCache(context) {
    vscode.window.showWarningMessage("This will throw away the cached documentation index for each documentation type, " +
        ...
        "Do you want to proceed?", { modal: true }, 'OK').then((selectedButton) => {
        if (selectedButton === 'OK') {
            Object.values(DocTypeName).forEach((currDocTypeString) => {
                context.globalState.update(currDocTypeString, undefined);
            });
        }
    });
}
exports.invalidateSalesforceReferenceCache = invalidateSalesforceReferenceCache;
/**
...
class SalesforceReferenceItem {
     ...
     */
    constructor(docNode, breadcrumb) {
...
exports.SalesforceReferenceItem = SalesforceReferenceItem;
class SalesforceReferenceDocType {
    /**
     *
     ...
     *                                      this is "/atlas.en-us.apexcode.meta/apexcode"
     */
    constructor(docTypeName, docTocPath, humanReadableDocPath) {
     ...
     */
    getSalesforceReferenceItems(context) {
        return __awaiter(this, void 0, void 0, function* () {
            //Try to use existing cached values, and populate the cache if not available
            let referenceItems = context.globalState.get(this.docTypeName);
            if (referenceItems === undefined) {
                ...
                const rootDocumentationNode = yield this.getRootDocumentationNode();
     ...
     */
    humanDocURL(selectedReferenceItem) {
     ...
     */
    convertDocNodeToSalesforceReferenceItems(documentationNode, breadcrumbString) {
        ...
        if (documentationNode.hasOwnProperty('children') && documentationNode.children !== undefined) {
            ...
            documentationNode.children.forEach((childDocumentationNode) => {
    ...
    getDocTOC() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = yield got_1.default(this.docTOCUrl).json();
            return body;
        });
    }
    /**
     ...
     */
    rawDocURL(folder, id, locale, version) {
...
class ApexSalesforceReferenceDocType extends SalesforceReferenceDocType {
    constructor() {
        super(DocTypeName.APEX, '/atlas.en-us.apexcode.meta', '/atlas.en-us.apexcode.meta/apexcode');
    }
    getRootDocumentationNode() {
        return __awaiter(this, void 0, void 0, function* () {
            //TODO: handle any errors
            const apexDocToc = yield this.getDocTOC();
            return apexDocToc.toc[0].children.find((node) => node.hasOwnProperty('id') && node.id === 'apex_reference');
        });
    }
}
class VisualforceSalesforceReferenceDocType extends SalesforceReferenceDocType {
    constructor() {
        super(DocTypeName.VISUALFORCE, '/atlas.en-us.pages.meta', '/atlas.en-us.pages.meta/pages');
    }
    getRootDocumentationNode() {
        return __awaiter(this, void 0, void 0, function* () {
            //TODO: handle any errors
            const vfDocToc = yield this.getDocTOC();
            return vfDocToc.toc.find((node) => node.hasOwnProperty('id') && node.id === 'pages_compref');
        });
    }
}
class LightningConsoleSalesforceReferenceDocType extends SalesforceReferenceDocType {
    constructor() {
        super(DocTypeName.LIGHTNING_CONSOLE, '/atlas.en-us.api_console.meta', '/atlas.en-us.api_console.meta/api_console');
    }
    getRootDocumentationNode() {
        return __awaiter(this, void 0, void 0, function* () {
            //TODO: handle any errors
            const lightningConsoleDocToc = yield this.getDocTOC();
            const lightningconsoleTopLevelToc = lightningConsoleDocToc.toc.find((node) => node.hasOwnProperty('id') && node.id === 'sforce_api_console_js_getting_started');
            return lightningconsoleTopLevelToc.children.find((node) => node.hasOwnProperty('id') && node.id === 'sforce_api_console_methods_lightning');
        });
    }
}
class ClassicConsoleSalesforceReferenceDocType extends SalesforceReferenceDocType {
    constructor() {
        super(DocTypeName.CLASSIC_CONSOLE, '/atlas.en-us.api_console.meta', '/atlas.en-us.api_console.meta/api_console');
    }
    getRootDocumentationNode() {
        return __awaiter(this, void 0, void 0, function* () {
            //TODO: handle any errors
            const classicConsoleDocToc = yield this.getDocTOC();
            const classicconsoleTopLevelToc = classicConsoleDocToc.toc.find((node) => node.hasOwnProperty('id') && node.id === 'sforce_api_console_intro');
            return classicconsoleTopLevelToc.children.find((node) => node.hasOwnProperty('id') && node.id === 'sforce_api_console_methods_classic');
        });
    }
}
class MetadataSalesforceReferenceDocType extends SalesforceReferenceDocType {
    constructor() {
        super(DocTypeName.METADATA, '/atlas.en-us.api_meta.meta', '/atlas.en-us.api_meta.meta/api_meta');
    }
    getRootDocumentationNode() {
        return __awaiter(this, void 0, void 0, function* () {
            //TODO: handle any errors
            const metadataDocToc = yield this.getDocTOC();
            return metadataDocToc.toc.find((node) => node.hasOwnProperty('text') && node.text === 'Reference');
        });
    }
}
exports.SalesforceReferenceDocTypes = {
...
const vscode = __webpack_require__(/*! vscode */ "vscode");
const SalesforceReference_1 = __webpack_require__(/*! ./SalesforceReference */ "./src/SalesforceReference.ts");
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        let apexReferenceDisposable = vscode.commands.registerCommand('vscode-salesforce-doc-lookup.salesforce-reference-apex', () => __awaiter(this, void 0, void 0, function* () {
            //todo: handle errs with try catch fin, maybe show something dynamic in the message, like the bounce in the old ST3 plugin
            let salesforceReferenceItems = yield SalesforceReference_1.SalesforceReferenceDocTypes.APEX.getSalesforceReferenceItems(context);
            //TODO handle errors
            vscode.window.showQuickPick(salesforceReferenceItems, { matchOnDetail: true }).then((selectedReferenceItem) => {
                if (selectedReferenceItem !== undefined) {
                    vscode.env.openExternal(vscode.Uri.parse(SalesforceReference_1.SalesforceReferenceDocTypes.APEX.humanDocURL(selectedReferenceItem)));
                }
            });
        }));
        let vfReferenceDisposable = vscode.commands.registerCommand('vscode-salesforce-doc-lookup.salesforce-reference-visualforce', () => __awaiter(this, void 0, void 0, function* () {
            //todo: handle errs with try catch fin, maybe show something dynamic in the message, like the bounce in the old ST3 plugin
            let salesforceReferenceItems = yield SalesforceReference_1.SalesforceReferenceDocTypes.VISUALFORCE.getSalesforceReferenceItems(context);
            //TODO handle errors
            vscode.window.showQuickPick(salesforceReferenceItems, { matchOnDetail: true }).then((selectedReferenceItem) => {
                if (selectedReferenceItem !== undefined) {
                    vscode.env.openExternal(vscode.Uri.parse(SalesforceReference_1.SalesforceReferenceDocTypes.VISUALFORCE.humanDocURL(selectedReferenceItem)));
                }
            });
        }));
        let lightningconsoleReferenceDisposable = vscode.commands.registerCommand('vscode-salesforce-doc-lookup.salesforce-reference-lightning-console', () => __awaiter(this, void 0, void 0, function* () {
            //todo: handle errs with try catch fin, maybe show something dynamic in the message, like the bounce in the old ST3 plugin
            let salesforceReferenceItems = yield SalesforceReference_1.SalesforceReferenceDocTypes.LIGHTNING_CONSOLE.getSalesforceReferenceItems(context);
            //TODO handle errors
            vscode.window.showQuickPick(salesforceReferenceItems, { matchOnDetail: true }).then((selectedReferenceItem) => {
                if (selectedReferenceItem !== undefined) {
                    vscode.env.openExternal(vscode.Uri.parse(SalesforceReference_1.SalesforceReferenceDocTypes.LIGHTNING_CONSOLE.humanDocURL(selectedReferenceItem)));
                }
            });
        }));
        let classicconsoleReferenceDisposable = vscode.commands.registerCommand('vscode-salesforce-doc-lookup.salesforce-reference-classic-console', () => __awaiter(this, void 0, void 0, function* () {
            //todo: handle errs with try catch fin, maybe show something dynamic in the message, like the bounce in the old ST3 plugin
            let salesforceReferenceItems = yield SalesforceReference_1.SalesforceReferenceDocTypes.CLASSIC_CONSOLE.getSalesforceReferenceItems(context);
            //TODO handle errors
            vscode.window.showQuickPick(salesforceReferenceItems, { matchOnDetail: true }).then((selectedReferenceItem) => {
                if (selectedReferenceItem !== undefined) {
                    vscode.env.openExternal(vscode.Uri.parse(SalesforceReference_1.SalesforceReferenceDocTypes.CLASSIC_CONSOLE.humanDocURL(selectedReferenceItem)));
                }
            });
        }));
        let metadataReferenceDisposable = vscode.commands.registerCommand('vscode-salesforce-doc-lookup.salesforce-reference-metadata', () => __awaiter(this, void 0, void 0, function* () {
            //todo: handle errs with try catch fin, maybe show something dynamic in the message, like the bounce in the old ST3 plugin
            let salesforceReferenceItems = yield SalesforceReference_1.SalesforceReferenceDocTypes.METADATA.getSalesforceReferenceItems(context);
            //TODO handle errors
            vscode.window.showQuickPick(salesforceReferenceItems, { matchOnDetail: true }).then((selectedReferenceItem) => {
                if (selectedReferenceItem !== undefined) {
                    vscode.env.openExternal(vscode.Uri.parse(SalesforceReference_1.SalesforceReferenceDocTypes.METADATA.humanDocURL(selectedReferenceItem)));
                }
            });
        }));
        let invalidateCacheDisposable = vscode.commands.registerCommand('vscode-salesforce-doc-lookup.salesforce-reference-invalidate-cache', () => __awaiter(this, void 0, void 0, function* () {
            SalesforceReference_1.invalidateSalesforceReferenceCache(context);
        }));
