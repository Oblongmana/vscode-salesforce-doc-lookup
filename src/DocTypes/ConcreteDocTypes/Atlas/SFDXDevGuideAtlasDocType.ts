...
export class SFDXDevGuideAtlasDocType extends AtlasDocType {
    constructor() {
        super(
            DocTypeID.SFDX_DEV
        );
    ...
    protected async getRootDocumentationNode(): Promise<AtlasTOC.DocumentationNode> {
        ...
        // The SFDX Developer Guide doc has (at time of writing 2022-07), multiple root nodes. So we simply create
