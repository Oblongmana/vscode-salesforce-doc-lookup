...
- [ ] Implement LWC/Aura Component Reference - very different to all other docs - it's a "dogfood" aura app. See the feature branch [feature/lwc-aura-doc](/Oblongmana/vscode-salesforce-doc-lookup/blob/feature/lwc-aura-doc) for details
